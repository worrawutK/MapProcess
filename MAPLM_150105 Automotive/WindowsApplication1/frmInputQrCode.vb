...
Public Class frmInputQrCode
    ...
    '        'Dim res As TdcResponse = m_TdcService.LotRequest(Parameter.EqNo, Parameter.LotNo, Parameter.StartMode)


    '        ''Rpl.LotNoTag MAP_Dicer
    '        'Using proxy As MAP_LM.RohmService.ApcsWebServiceSoapClient = New MAP_LM.RohmService.ApcsWebServiceSoapClient()
    ...
    '    'SetupLot(LotNo, MCNo, lbOp.Text, "MAP", "0250")
...
FailTDC:
                ...
                Case "Input GL No."
                    ...
                    If TbQRInput.Text.Length <> 6 Then
                        ...
                        Exit Sub
                    End If
                    Form1.DBxDataSet.MAPLMData.Rows(0)("GLCheck") = TbQRInput.Text
                    Me.Close()
...
#End Region
    ...
    'Private Function PermiisionCheck(ByVal ETC2 As String, ByVal strNextOperatorNo As String, ByVal GetUserAuthenGroupByMCType As String, ByVal GL_Group As String, ByVal Procees As String, ByVal MCNo As String) As Boolean
    ...
    '        If AuthenPass = False Then MsgBox("OP No.นี้ไม่สามารถรัน Lot Automotive ได้  กรุณาติดต่อ ETG/SYSTEM")
    ...
    '        If AuthenPass = False Then MsgBox("OP No.นี้ไม่สามารถรันได้  กรุณาติดต่อ ETG/SYSTEM")
