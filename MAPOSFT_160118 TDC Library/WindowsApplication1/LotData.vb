Public Class LotData
    ...
    Public Property Recipe() As String
        ...
        End Set
    End Property
    Private c_CarrierInfo As MAP_OSFT.iLibraryService.CarrierInfo
    Public Property CarrierInfo() As MAP_OSFT.iLibraryService.CarrierInfo
        Get
            Return c_CarrierInfo
        End Get
        Set(ByVal value As MAP_OSFT.iLibraryService.CarrierInfo)
            c_CarrierInfo = value
        End Set
    End Property
End Class
