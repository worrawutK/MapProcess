...
Public Class clsDBMap_MapData
    Private importLetterCapitalize As Boolean = False
    Const HEADER As String = "clsDBMap_MapData"
    Enum keys
        MCNo
        LotNo
        LotStartTime
    ...
    Const tableName As String = "Map_MapData"
    ...
    Private Function tableinfo() As String()
        ...
        "MCNo", "varchar", 10, "", "Unknown", _
        "Process", "varchar", 10, "", "Unknown", _
        "ProcessMode", "varchar", 20, "", "Unknown", _
        "LotNo", "varchar", 10, "", "Unknown", _
        "MAPData", "binary", 9999, "", "0x00", _
        "LotStartTime", "datetime", "", "", "2000-1-1 01:01:01", _
        "LotEndTime", "datetime", "", "", "2000-1-1 01:01:01", _
        "Remark", "varchar", 50, "", "Unknown" _
      }
        Return ans
    End Function
    ...
    '        Next
    '        sqlcmd.CommandText = sqlcmd.CommandText.Substring(0, sqlcmd.CommandText.Length - "AND ".Length)
    '        sqlcmd.CommandText += " ORDER BY Serial DESC;"
    '        reader = sqlcmd.ExecuteReader
    '        Dim value As String = ""
    '        Do While (reader.Read())
    '            value = value & reader.Item("LotID") & "," & reader.Item(strItem) & ","
    '        Loop
    '        reader.Close()
    '        value = value.TrimEnd(",")
